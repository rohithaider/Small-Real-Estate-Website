...
const cardData = [
    {
      ...
      description: 'It takes 2-3 weeks to get your first blog post ready. That includes the in-depth research & creation of your monthly content ui/ux strategy that we do writing your first blog post.'
    },
    {
      header: 'Does TailGrids Support React?',
      description: 'TailGrids offers React components and is well-integrated into modern web frameworks to help developers build stunning UIs faster.'
    },
    {
      header: 'What Makes TailGrids Unique?',
      description: 'TailGrids provides a wide variety of components and templates, which saves time and simplifies the UI development process for developers and designers.'
    },
    {
      header: 'Why Use TailGrids?',
      description: 'Using TailGrids can significantly speed up your UI development process, with reusable components that work across different platforms and projects.'
    }
  ];
    ...
    <div className="w-full px-4 lg:w-1/2">
      <div className="mb-12 flex lg:mb-[70px]">
        ...
        <div className="w-full">
                <h3 className="mb-6 text-xl font-semibold text-dark dark:text-black sm:text-2xl lg:text-xl xl:text-2xl">
                  {header}
                </h3>
...
function CardContainer() {
  return (
    <div className="-mx-4 flex flex-wrap">
      {cardData.map(card=>{
        return(
            <Card header={card.header} description={card.description}/>
        )
      })}
    </div>
  );
...
export default function FAQ() {
  return (
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-white lg:pb-[50px] lg:pt-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <Titles
              title={`FAQ`}
              titleClass={`mb-2 block text-lg font-semibold text-primary`}
              header={`Any Questions? Look Here`}
              headerClass={`mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-black sm:text-4xl md:text-[40px]`}
              description={`There are many variations of passages of Lorem Ipsum available
                but the majority have suffered alteration in some form.`}
              descriptionClass={`mx-auto max-w-[485px] text-base text-body-color dark:text-dark-6`}
            />
          </div>
        </div>
        <CardContainer />
