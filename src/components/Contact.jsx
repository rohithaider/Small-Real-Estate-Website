...
function Form() {
  return (
    <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
      <div className=" rounded-lg bg-white px-8 py-10 shadow-testimonial  dark:shadow-none sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]">
...
function ContactInfo(){
    return(
        ...
        <div className="mb-8 flex w-[330px] max-w-full">
          ...
          <div>
            <h5 className="mb-[18px] text-lg font-semibold text-dark dark:text-black">
              Our Location
            </h5>
