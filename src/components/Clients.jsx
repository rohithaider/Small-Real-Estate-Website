...
function Card({image,profession,name}) {
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
      <div className="group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-white dark:shadow-none">
        ...
        <div className="text-center">
          <h4 className="mb-1 text-lg font-semibold text-dark dark:text-black">
            {name}
          </h4>
...
function CardContainer() {
  return (
    <div className="-mx-4 flex flex-wrap justify-center">
      {cardsData.map(card=>(
        <Card name={card.name} profession={card.profession} image={card.image}/>
      ))}
    </div>
  );
}
      ...
      <div className="w-full px-4">
        <div className="mx-auto  max-w-[485px] text-center">
          <Titles
            ...
            descriptionClass={`text-base text-body-color dark:text-dark-6`}
          />
        </div>
      </div>
    </div>
...
export default function Clients() {
  return (
    <section
      id="team"
      className="overflow-hidden bg-gray-1 pb-12 pt-20 dark:bg-[#F9FAFB] lg:pb-[90px] lg:pt-[120px]"
    >
      <MainContainer />
    </section>
  );
