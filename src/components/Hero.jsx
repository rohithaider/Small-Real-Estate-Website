    ...
    return(
        <div className="hero-content  mx-auto max-w-[780px] text-center">
            ...
            <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
              <li>
                <Button name="Book Now" value = "inline-flex items-center justify-center rounded-md bg-white px-7 py-[14px] text-center text-base font-medium text-dark shadow-1 transition duration-300 ease-in-out hover:bg-gray-2 hover:text-body-color"/>
              </li>
              <li>
                <Button name="Contact Us" value="lex items-center gap-4 rounded-md bg-white/[0.12] px-6 py-[14px] text-base font-medium text-white transition duration-300 ease-in-out hover:bg-white hover:text-dark"/>
              </li>
            </ul>
    ...
    return(
        <div className="w-full px-4">
          <div className=" relative z-10 mx-auto max-w-[845px]">
            ...
            <DotSquare value="absolute -left-9 bottom-0 z-[-1]" />
            <DotSquare value="absolute -right-6 -top-6 z-[-1]"/>
          </div>
        </div>
    )
}
